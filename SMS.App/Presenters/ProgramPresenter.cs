...
namespace SMS.App.Presenters
{
    public class ProgramPresenter
    {
        ...
        private void LoadProgramList(string? search = null)
        {
            ...
            if (search != null)
            {
                _programList = _programList.Where(c => c.ProgramId.ToString().Contains(search) || c.ProgramName.Contains(search));
            }
        ...
        private void DeleteEvent(object? sender, EventArgs e)
        {
            try
            {
                ...
                _programView.SetMessage("Program Deleted Succcessfully");
                LoadProgramList();
            }
            catch (Exception ex)
            {
