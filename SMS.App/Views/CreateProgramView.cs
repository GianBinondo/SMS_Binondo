...
namespace SMS.App.Views
{
    public partial class CreateProgramView : Form
    {
        ...
        public CreateProgramView(Programs? editProgram = null)
        {
            ...
            if (editProgram != null)
            {
                textBoxProgramName.Text = editProgram.ProgramName;
                textBoxDescription.Text = editProgram.Description;
            }
        }
        ...
        private async void buttonCreate_Click(object sender, EventArgs e)
        {
            if (_editProgram == null)
            {
                ...
                await _dbContext.AddAsync(_editProgram);
            ...
            else
            {
                ...
                MessageBox.Show("Program Update Successfully");
            }
